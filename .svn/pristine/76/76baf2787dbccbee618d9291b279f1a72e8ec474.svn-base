...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private com.aiko.oa.workflow.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
    		com.aiko.oa.workflow.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public com.aiko.oa.workflow.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(com.aiko.oa.workflow.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
