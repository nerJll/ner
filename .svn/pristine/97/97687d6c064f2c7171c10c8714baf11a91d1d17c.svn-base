...
public class WorkflowRequestTableRecord  implements java.io.Serializable {
    ...
    private com.aiko.oa.workflow.WorkflowRequestTableField[] workflowRequestTableFields;
    ...
    public WorkflowRequestTableRecord(
           ...
           com.aiko.oa.workflow.WorkflowRequestTableField[] workflowRequestTableFields) {
     ...
     */
    public com.aiko.oa.workflow.WorkflowRequestTableField[] getWorkflowRequestTableFields() {
        return workflowRequestTableFields;
    }
     ...
     */
    public void setWorkflowRequestTableFields(com.aiko.oa.workflow.WorkflowRequestTableField[] workflowRequestTableFields) {
        this.workflowRequestTableFields = workflowRequestTableFields;
    }
