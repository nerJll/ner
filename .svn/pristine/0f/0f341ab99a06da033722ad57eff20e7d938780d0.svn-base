...
public class WorkflowServicePortTypeProxy implements com.aiko.oa.workflow.WorkflowServicePortType {
  private String _endpoint = null;
  private com.aiko.oa.workflow.WorkflowServicePortType workflowServicePortType = null;
  ...
  private void _initWorkflowServicePortTypeProxy() {
    try {
      workflowServicePortType = (new com.aiko.oa.workflow.WorkflowServiceLocator()).getWorkflowServiceHttpPort();
  ...
  public com.aiko.oa.workflow.WorkflowServicePortType getWorkflowServicePortType() {
    if (workflowServicePortType == null)
      _initWorkflowServicePortTypeProxy();
