...
public class WorkflowDetailTableInfo  implements java.io.Serializable {
    ...
    private com.aiko.oa.workflow.WorkflowRequestTableRecord[] workflowRequestTableRecords;
    ...
    public WorkflowDetailTableInfo(
           ...
           com.aiko.oa.workflow.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
     ...
     */
    public com.aiko.oa.workflow.WorkflowRequestTableRecord[] getWorkflowRequestTableRecords() {
        return workflowRequestTableRecords;
    }
     ...
     */
    public void setWorkflowRequestTableRecords(com.aiko.oa.workflow.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
        this.workflowRequestTableRecords = workflowRequestTableRecords;
    }
