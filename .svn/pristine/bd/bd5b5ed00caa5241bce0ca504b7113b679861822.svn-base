...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements com.aiko.oa.workflow.WorkflowService {
    ...
    public com.aiko.oa.workflow.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.aiko.oa.workflow.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.aiko.oa.workflow.WorkflowServiceHttpBindingStub _stub = new com.aiko.oa.workflow.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.aiko.oa.workflow.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.aiko.oa.workflow.WorkflowServiceHttpBindingStub _stub = new com.aiko.oa.workflow.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
